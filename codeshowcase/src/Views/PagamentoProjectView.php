    ...
    <div class="payment-wrapper">
        <div class="payment-container">
            ...
            <form action="/comprar/processar" method="POST">
                <input type="hidden" name="id" value="<?= htmlspecialchars($project->getId()) ?>">
                ...
                <a href="/comprar/sucesso?id=<?= htmlspecialchars($project->getId()) ?>" class="btn-payment" id="btnPagamento" style="text-decoration: none; text-align: center; display: inline-block;">
