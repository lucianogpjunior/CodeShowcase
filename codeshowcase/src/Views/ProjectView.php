...
.modal-info-item span.uuid-text {
    font-family: var(--font-mono);
    font-size: 10px;
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            ...
            <div class="modal-actions">
                <a id="modalBtnComprar" href="/projetos/comprar" class="btn btn-accent">Comprar projeto</a>
                <a id="modalBtnEditar" href="/projetos/editar" class="btn btn-outline">Editar</a>
